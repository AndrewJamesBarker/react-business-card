...
export default function Main () {
  return (
    ...
    <p className="text-body">Playing/writing/recording/listening to music. Fiction/Non-fiction and long-form articles of all flavours. Coffee, ya it's cliche, but it's true :) Friends, beers, chess and Foosball on a friday night!</p>
  </div>
  )
